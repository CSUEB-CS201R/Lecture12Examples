...
//Precondition: 0 <= startIndex < numberUsed.  Referenced array elements have values.
//Postcondition: Returns the index i such that a[i] is the smallest of the values
